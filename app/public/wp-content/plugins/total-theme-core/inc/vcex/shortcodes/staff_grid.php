...
if ( ! class_exists( 'VCEX_Staff_Grid_Shortcode' ) ) {
	...
	class VCEX_Staff_Grid_Shortcode extends TotalThemeCore\Vcex\Shortcode_Abstract {

		/**
		 * Shortcode tag.
		 */
		public const TAG = 'vcex_staff_grid';
		...
		public static function get_title(): string {
			return esc_html__( 'Staff Grid', 'total-theme-core' );
		}
		...
		public static function get_description(): string {
			return esc_html__( 'Recent staff posts grid', 'total-theme-core' );
		}
