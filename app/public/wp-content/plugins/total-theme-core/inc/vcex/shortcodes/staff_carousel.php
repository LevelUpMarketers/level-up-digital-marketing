...
if ( ! class_exists( 'VCEX_Staff_Carousel_Shortcode' ) ) {
	...
	class VCEX_Staff_Carousel_Shortcode extends TotalThemeCore\Vcex\Shortcode_Abstract {

		/**
		 * Shortcode tag.
		 */
		public const TAG = 'vcex_staff_carousel';
		...
		public static function get_title(): string {
			return esc_html__( 'Staff Carousel', 'total-theme-core' );
		}
		...
		public static function get_description(): string {
			return esc_html__( 'Recent staff posts carousel', 'total-theme-core' );
		}
		...
		public static function register_vc_autocomplete_hooks(): void {
			...
			add_filter(
				...
				'TotalThemeCore\WPBakery\Autocomplete\Staff_Categories::callback'
			);
			add_filter(
			...
			add_filter(
				...
				'TotalThemeCore\WPBakery\Autocomplete\Staff_Categories::render'
			);
			add_filter(
