...
if ( ! class_exists( 'VCEX_Term_Description_Shortcode' ) ) {
	...
	class VCEX_Term_Description_Shortcode extends TotalThemeCore\Vcex\Shortcode_Abstract {

		/**
		 * Shortcode tag.
		 */
		public const TAG = 'vcex_term_description';
		...
		public static function get_title(): string {
			return esc_html__( 'Term Description', 'total-theme-core' );
		}
		...
		public static function get_description(): string {
			return esc_html__( 'Current term description', 'total-theme-core' );
		}
