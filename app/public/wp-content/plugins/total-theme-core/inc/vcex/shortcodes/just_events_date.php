 ...
 */
if ( ! class_exists( 'Vcex_Just_Events_Date_Shortcode' ) ) {

	class Vcex_Just_Events_Date_Shortcode extends \TotalThemeCore\Vcex\Shortcode_Abstract {

		/**
		 * Shortcode tag.
		 */
		public const TAG = 'vcex_just_events_date';
		...
		public static function get_title(): string {
			return esc_html__( 'Just Events: Date', 'total-theme-core' );
		}
		...
		public static function get_description(): string {
			return esc_html__( 'Display the current event start/end date.', 'total-theme-core' );
		}
		...
		public static function get_params_list(): array {
			return [
				...
				[
					...
					'choices' => [
						'' => esc_html__( 'Start & End Dates', 'total-theme-core' ),
						'start' => esc_html__( 'Start Date Only', 'total-theme-core' ),
						'end' => esc_html__( 'End Date Only', 'total-theme-core' ),
					],
					'editors' => [ 'wpbakery', 'elementor' ],
				],
				[
				...
				[
					'type' => 'vcex_ofswitch',
					'std' => 'true',
					'heading' => esc_html__( 'Show time', 'total-theme-core' ),
				...
				[
					...
					'selector' => '.vcex-just-events-date',
					'group' => esc_html__( 'Typography', 'total-theme-core' ),
					'editors' => [ 'elementor' ],
				],
				[
...
new Vcex_Just_Events_Date_Shortcode;
