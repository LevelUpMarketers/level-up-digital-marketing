...
use VCEX_Divider_Dots_Shortcode as Shortcode;
...
class Divider_Dots extends Widget_Base {
	...
	public function get_title() {
		return \esc_html__( 'Divider Dots', 'total-theme-core' ) . '  (Total)';
	}
