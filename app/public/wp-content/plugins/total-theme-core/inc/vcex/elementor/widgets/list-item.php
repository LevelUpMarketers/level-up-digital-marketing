...
class List_Item extends Widget_Base {
	...
	public function get_name() {
		return VCEX_List_Item_Shortcode::TAG;
	}

	public function get_title() {
		return \esc_html__( 'List Item', 'total-theme-core' ) . '  (Total)';
	}
	...
	protected function register_controls() {
		$settings = new Widget_Settings( VCEX_List_Item_Shortcode::get_params() );
	...
	protected function render() {
		...
		echo VCEX_List_Item_Shortcode::output( $atts, $content );
	}
